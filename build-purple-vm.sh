...
RAW_IMG="/workspaces/gentoo/purple-test.raw"
QCOW_IMG="/workspaces/gentoo/purple-test.qcow2"
MOUNT="/tmp/purple-qemu-mount"
SIZE="22G"
...
mkfs.ext4 -F -L purple-root "$RAW_IMG"
...
# Bind scripts directory at /purple-scripts in the VM
cp -r "$NSPAWN_ROOT/../scripts" "$MOUNT/purple-scripts" 2>/dev/null || \
  cp -r /workspaces/gentoo/root.x86_64/scripts "$MOUNT/purple-scripts"
