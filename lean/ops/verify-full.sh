...
echo "== 8 agent binaries installed =="
...
printf trustme > /tmp/_v; SIG=$(maia-crypto sign /tmp/_v)
...
echo "== Nexus ledger =="
chk "nexus-verify clean" 'nexus-verify'
...
echo "== Alcyone read-only enforcement =="
